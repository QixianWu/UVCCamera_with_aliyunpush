...
//    /**
//     * 根据像素数量获取每像素比特数
//     * 针对960x540等中低分辨率优化，提高清晰度
//     */
//    private double getBitsPerPixel(long pixelCount) {
//        if (pixelCount <= 518400) { // 960x540等中低分辨率
//            return 0.15; // 提高中低分辨率的每像素比特数，改善清晰度
...
//        // } else if (pixelCount <= 518400) { // 960x540等中低分辨率
//        //     return fps <= 30 ? 800_000 : 1_200_000; // 提高最小码率，确保清晰度
//        // } else
//        if (pixelCount <= 921600) { // 1280x720
//            return fps <= 30 ? 1_000_000 : 1_500_000;
//        } else if (pixelCount <= 2073600) { // 1920x1080
